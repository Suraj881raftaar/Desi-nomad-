...
const treks = [
  { id: 'hidden-valley', name: 'Hampta Pass crossover', region: 'Himachal', duration: 5, price: 10800, highlights: 'Village stays, pine forests, high pass crossover', altitude: '14,100 ft', description: 'A spectacular crossover trek starting from the lush green valleys of Kullu/Manali and ending in the barren landscape of Spiti.', file: 'hampta_pass.webp', title: 'Hampta Pass Crossover Trek Himachal', caption: 'Hikers traversing the snow ridge at Hampta Pass summit, Himachal Pradesh, India' },
  { id: 'beas-kund', name: 'Beas Kund Lake Trek', region: 'Himachal', duration: 3, price: 6500, highlights: 'Glacial lake, peak views of Hanuman Tibba', altitude: '12,772 ft', description: 'Walk to the source of the Beas River, where an emerald glacial lake sits surrounded by towering peaks.', file: 'beas_kund.webp', title: 'Beas Kund Glacial Lake Trek', caption: 'Pristine emerald glacial lake at the source of Beas River, Manali' },
  { id: 'mystic-meadows', name: 'Mystic Dayara Bugyal Meadows', region: 'Uttarakhand', duration: 3, price: 8200, highlights: 'River crossings, folk heritage, open ridge camps', altitude: '11,800 ft', description: 'An idyllic weekend trek perfect for beginners and families through dense pine woodlands and alpine meadows.', file: 'dayara_bugyal.webp', title: 'Mystic Dayara Bugyal Meadows Trek', caption: 'Vast alpine green meadows of Dayara Bugyal, Uttarakhand' },
  { id: 'valley-flowers', name: 'Valley of Flowers & Hemkund Sahib', region: 'Uttarakhand', duration: 6, price: 11500, highlights: 'UNESCO World Heritage site, alpine blooms, holy lake', altitude: '14,107 ft', description: 'Hike through a high-altitude national park containing hundreds of species of wild alpine flowers.', file: 'valley_of_flowers.webp', title: 'Valley of Flowers National Park Uttarakhand', caption: 'Beautiful mountain valley carpeted with wildflowers, UNESCO site' },
  { id: 'kedarkantha-snow', name: 'Kedarkantha Winter Summit', region: 'Uttarakhand', duration: 6, price: 8200, highlights: 'Pristine winter snow, pine clearing camps, summit ridge', altitude: '12,500 ft', description: 'Famous as the ultimate winter snow trek. Climb through pine forests filled with deep snow.', file: 'kedarkantha.webp', title: 'Kedarkantha Snow Peak Summit', caption: 'Trekkers climbing the snowy summit ridge of Kedarkantha in winter' },
  { id: 'nomads-peak', name: 'Dzongri Ridge Expedition', region: 'Sikkim', duration: 7, price: 18500, highlights: 'Alpine blooms, panoramic Kanchenjunga views', altitude: '13,680 ft', description: 'A demanding but life-changing expedition that takes you into the heart of Sikkims wild mountains.', file: 'dzongri_ridge.webp', title: 'Dzongri Ridge Expedition Sikkim', caption: 'Panoramic views of Mount Kanchenjunga from the Dzongri Ridge top' },
  { id: 'goechala-pass', name: 'Goechala Pass Expedition', region: 'Sikkim', duration: 10, price: 21000, highlights: 'Kanchenjunga face view, rhododendron forests, Samiti lake', altitude: '15,100 ft', description: 'The pinnacle of high-altitude Himalayan trekking in East India.', file: 'goechala.webp', title: 'Goechala Pass Trek Sikkim', caption: 'The massive face of Mt Kanchenjunga from Goechala view point' },
  { id: 'kashmir-lakes', name: 'Kashmir Great Lakes Traverse', region: 'Kashmir', duration: 8, price: 15800, highlights: 'Seven alpine lakes, snow bridges, maple forests', altitude: '13,750 ft', description: 'Traverse through seven pristine alpine lakes, vast meadows, and pass through high mountain cols.', file: 'kashmir_lakes.webp', title: 'Kashmir Great Lakes Alpine Traverse', caption: 'Beautiful clear blue alpine lake surrounded by green valleys in Kashmir' },
  { id: 'tarsar-marsar', name: 'Tarsar Marsar Twin Lakes', region: 'Kashmir', duration: 7, price: 13800, highlights: 'Almond-shaped lakes, flower meadows of Lidderwat', altitude: '13,201 ft', description: 'Explore the twin almond-shaped alpine lakes of Tarsar and Marsar.', file: 'tarsar_marsar.webp', title: 'Tarsar Marsar Twin Lakes Kashmir', caption: 'Campsite pitched on the green banks of Tarsar Lake, Aru Valley' },
  { id: 'markha-valley', name: 'Markha Valley Trek', region: 'Ladakh', duration: 9, price: 17500, highlights: 'Cold desert valley, ancient monasteries, Kongmaru La pass', altitude: '17,100 ft', description: 'Journey through the ancient Buddhist Kingdom of Ladakh.', file: 'markha_valley.webp', title: 'Markha Valley Cold Desert Trek Ladakh', caption: 'Stupas and canyon routes in the barren Markha Valley, Ladakh' },
  { id: 'kudremukh-peak', name: 'Kudremukh Peak Ridge', region: 'Karnataka', duration: 2, price: 3200, highlights: 'Horse-faced peak, shola forest walk, misty grasslands', altitude: '6,207 ft', description: 'Hike up the horse-shaped ridge in Kudremukh National Park.', file: 'kudremukh.webp', title: 'Kudremukh Peak Grasslands Karnataka', caption: 'Lush rolling green hills and shola cloud forests of Kudremukh peak' },
  { id: 'kumara-parvatha', name: 'Kumara Parvatha Challenge', region: 'Karnataka', duration: 2, price: 4200, highlights: 'Shesha Parvatha ridge, cloud forest camp', altitude: '5,617 ft', description: 'Renowned as the toughest trek in South India.', file: 'kumara_parvatha.webp', title: 'Kumara Parvatha Ridge Trail Karnataka', caption: 'Climbing past Shesha Parvatha cliff trails to Kumara Parvatha peak' },
  { id: 'sahyadri-ridge', name: 'Harishchandragad Fort Climb', region: 'Maharashtra', duration: 2, price: 1800, highlights: 'Ancient fort ruins, Kokankada 1,800ft vertical drop', altitude: '4,670 ft', description: 'Experience the magic of the Sahyadri mountains in Maharashtra.', file: 'harishchandragad.webp', title: 'Kokankada Cliff Harishchandragad Maharashtra', caption: 'The massive 1,800 ft vertical drop horseshoe cliff of Kokankada' },
  { id: 'kalsubai-peak', name: 'Kalsubai Peak Summit', region: 'Maharashtra', duration: 1, price: 1400, highlights: 'Highest peak of Maharashtra, steel ladder climbs', altitude: '5,400 ft', description: 'Climb the highest point in Maharashtra.', file: 'kalsubai.webp', title: 'Kalsubai Peak Ladder Climb Maharashtra', caption: 'Climbing the steel ladders leading to the highest point of Maharashtra' },
  { id: 'western-tea-trail', name: 'Meesapulimala Peak Trail', region: 'Kerala', duration: 2, price: 3800, highlights: 'Tea gardens, cloud forests, endemic wildlife', altitude: '8,661 ft', description: 'Walk through high-altitude cloud forests and tea estates.', file: 'meesapulimala.webp', title: 'Meesapulimala Peak Cloud Valley Kerala', caption: 'Misty cloud valleys and tea estates of Meesapulimala, Munnar' },
  { id: 'har-ki-dun', name: 'Har Ki Dun Valley', region: 'Uttarakhand', duration: 6, price: 8200, highlights: 'Ancient wooden villages, alpine forests, peak views of Swargarohini', altitude: '11,675 ft', description: 'Trek to the Valley of Shiva, a cradle-shaped valley surrounded by snow-covered peaks.', file: 'har_ki_dun.webp', title: 'Har Ki Dun Valley Trek Uttarakhand', caption: 'Beautiful wooden houses in ancient Osla village on Har Ki Dun trail' },
  { id: 'sandakphu-singalila', name: 'Sandakphu Ridge Trek', region: 'West Bengal', duration: 6, price: 10500, highlights: 'Views of Mt. Everest & Kanchenjunga, Sleeping Buddha ridge', altitude: '11,930 ft', description: 'Hike along the famous Singalila Ridge separating India and Nepal.', file: 'sandakphu.webp', title: 'Sandakphu Singalila Ridge Trek West Bengal', caption: 'Panoramic Sleeping Buddha mountain peak range from Sandakphu summit' },
  { id: 'pin-parvati', name: 'Pin Parvati Pass Crossover', region: 'Himachal', duration: 11, price: 24500, highlights: 'Glaciated crossover, Mantalai lake, Pin valley cold desert', altitude: '17,450 ft', description: 'Traverse from the lush green Parvati Valley in Kullu to the stark cold desert of Pin Valley in Spiti across massive glaciers.', file: 'pin_parvati.webp', title: 'Pin Parvati Pass Crossover Expedition', caption: 'Trekkers traversing glacier moraines on Pin Parvati pass' },
  { id: 'rupin-pass', name: 'Rupin Pass Crossover', region: 'Uttarakhand', duration: 7, price: 12800, highlights: 'Three-stage waterfall climb, snow bridges, Jhaka hanging village', altitude: '15,250 ft', description: 'A classic crossover trek taking you from Dhaula in Uttarakhand to Sangla in Himachal Pradesh.', file: 'rupin_pass.webp', title: 'Rupin Pass Crossover Trail', caption: 'Waterfall gully climb on Rupin pass trail' },
  { id: 'bhrigu-lake', name: 'Bhrigu Lake Ridge', region: 'Himachal', duration: 4, price: 7200, highlights: 'Sacred color-changing lake, high meadows, Solang Valley views', altitude: '14,100 ft', description: 'Ascend to the sacred high-altitude alpine lake associated with Maharishi Bhrigu.', file: 'bhrigu_lake.webp', title: 'Bhrigu Lake Ridge Trek Manali', caption: 'Pristine high altitude Bhrigu lake' },
  { id: 'kuari-pass', name: 'Kuari Pass Lord Curzon Trail', region: 'Uttarakhand', duration: 6, price: 8800, highlights: 'Front-row views of Mt Nanda Devi, Gorson Bugyal, oak forests', altitude: '12,516 ft', description: 'Walk Lord Curzon’s legendary trail in Garhwal with views of Nanda Devi.', file: 'kuari_pass.webp', title: 'Kuari Pass Nanda Devi Trail', caption: 'Panoramic Nanda Devi peak view from Kuari pass ridge' },
  { id: 'brahmatal', name: 'Brahmatal Winter Summit', region: 'Uttarakhand', duration: 6, price: 8500, highlights: 'Bekaltal lake, Mt Trishul & Nanda Ghunti face view, snow trails', altitude: '12,250 ft', description: 'Trek to the high-altitude lake offering close-up views of Mount Trishul.', file: 'brahmatal.webp', title: 'Brahmatal Winter Snow Summit', caption: 'Frozen Bekaltal lake surrounded by winter snow' },
  { id: 'chadar-frozen-river', name: 'Chadar Frozen River Expedition', region: 'Ladakh', duration: 9, price: 28000, highlights: 'Walking on frozen Zanskar river, ice caves, sub-zero canyoning', altitude: '11,125 ft', description: 'Walk on the thick sheet of ice formed over the roaring Zanskar River.', file: 'chadar_river.webp', title: 'Chadar Frozen River Zanskar Expedition', caption: 'Hikers walking on frozen Zanskar river ice sheet' },
  { id: 'sandhan-valley', name: 'Sandhan Valley Canyon Trail', region: 'Maharashtra', duration: 2, price: 2200, highlights: 'Valley of Shadows, rappelling cliffs, natural water pools, cave camping', altitude: '4,100 ft', description: 'Experience rock climbing and rappelling down cliffs in Bhandardara canyon.', file: 'sandhan_valley.webp', title: 'Sandhan Valley Canyon Trail Maharashtra', caption: 'Rappelling down cliff faces in Sandhan valley' },
  { id: 'rajmachi-fort', name: 'Rajmachi Fort Monsoon Walk', region: 'Maharashtra', duration: 2, price: 1600, highlights: 'Twin forts, fireflies forest, Kataldhar waterfall', altitude: '2,710 ft', description: 'Traverse lush plateau trails and explore twin Maratha fort structures.', file: 'rajmachi_fort.webp', title: 'Rajmachi Fort Monsoon Walk Lonavala', caption: 'Green monsoon mist covering Rajmachi fort plateau' }
];
